class UserDocumentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_document.save
        format.html { redirect_to @user_document, flash: { success: 'User document was successfully created.' } }
  ...
  def update
    respond_to do |format|
      if @user_document.update(user_document_params)
        format.html { redirect_to @user_document, flash: { success: 'User document was successfully updated.' } }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to user_documents_url, flash: { success: 'User document was successfully destroyed.' } }
  ...
  def user_document_params
    params.require(:user_document).permit(:user_id, :document_type_id, :attached_document, :expiration_date)
  end
end
