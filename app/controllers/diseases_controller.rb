class DiseasesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @disease.save
        format.html { redirect_to @disease, flash: { success: 'Disease was successfully created.' } }
  ...
  def update
    respond_to do |format|
      if @disease.update(disease_params)
        format.html { redirect_to @disease, flash: { success: 'Disease was successfully updated.' } }
  ...
  def destroy
    @disease.destroy
    respond_to do |format|
      format.html { redirect_to diseases_url, flash: { success: 'Disease was successfully destroyed.' } }
