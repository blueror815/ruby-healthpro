class DocumentTypesController < ApplicationController
  ...
  def new
    ...
    @document_type = @job_type.document_types.new
  end
  ...
  def create
    ...
    respond_to do |format|
      if @document_type.save
        format.html { redirect_to @document_type, flash: { success: 'Document type was successfully created.' } }
  ...
  def update
    respond_to do |format|
      if @document_type.update(document_type_params)
        format.html { redirect_to @document_type, flash: { success: 'Document type was successfully updated.' } }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to document_types_url, flash: { success: 'Document type was successfully destroyed.' } }
  ...
  def document_type_params
    params.require(:document_type).permit(:document_name, :job_type_id)
  end
end
