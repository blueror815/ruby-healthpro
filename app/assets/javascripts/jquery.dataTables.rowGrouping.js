            ...
            function fnCreateGroupRow(sGroupCleaned, sGroup, iColspan) {
                ...
                if (properties.bExpandableGrouping) {
                    ...
                    if (!_fnIsGroupCollapsed(sGroupCleaned)) {
                        nCell.className += " expanded-group fa";
                        oGroup.state = "expanded";
                    } else {
                        nCell.className += " collapsed-group fa";
                ...
                var innerCells = $(nCell).find("span");
                $.each($(innerCells), function(i){
                    var cell = document.createElement('td');
                    cell.innerHTML = innerCells[i].innerHTML;
                    nGroup.appendChild(cell);
                });
                innerCells.remove();
