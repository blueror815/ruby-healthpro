...
class JobTypesControllerTest < ActionController::TestCase
  ...
  test 'should create job_type' do
    assert_difference('JobType.count') do
      post :create, job_type: { short_user_type: @job_type.short_user_type, title: @job_type.title, user_type: @job_type.user_type }
    end
  ...
  test 'should update job_type' do
    patch :update, id: @job_type, job_type: { short_user_type: @job_type.short_user_type, title: @job_type.title, user_type: @job_type.user_type }
    assert_redirected_to job_type_path(assigns(:job_type))
  end
